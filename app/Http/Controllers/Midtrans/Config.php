...
{   
    public static $serverKey = "SB-Mid-server-DtZ8MK_eEae-CfDqkfewzWPp";
    /**
     * Your merchant's client key
     *
     * @static
     */
    public static $clientKey = "SB-Mid-client-pqddeuTDEgchp9XX";
    /**
     * True for production
     ...
     * @static
     */
    //jika masih menggunakan environment sandbox $isProduction = false
